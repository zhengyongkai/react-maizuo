...
export default function OrderPage() {
  ...
  function onBuyTicket(e: React.MouseEvent<HTMLDivElement, MouseEvent>, item: preOrderEntity) {
    e.stopPropagation();
  ...
  return (
    <Loading loading={loading}>
      <div>
        <NavTitle backFn={() => navigate('/name/my')} back title={'电影订单'}></NavTitle>
      </div>
        ...
        {orderList.map((item) => {
          return (
            <div
              ...
              <div className={Styles['order-item-bottom']} onClick={(e) => onBuyTicket(e, item)}>
