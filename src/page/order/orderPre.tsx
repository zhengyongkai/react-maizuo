...
export default function PreOrder() {
  ...
  const userId = useSelector<userState, number>((state) => state.user.userData.userId);
  ...
  return (
    <>
      <NavTitle back title={preOrderInfo.filmName}>
        <div className={Styles['order-remainder']}>{secondToMMSS(remainder)}</div>
      </NavTitle>
      <Loading loading={loading}>
        <div className={Styles['order-wrapper']}>
          ...
          <div className={Styles['order-menu-items']}>
            <div>
              <div className={Styles['order-menu-item']} onClick={() => setShowCard(true)}>
              ...
              <div className={Styles['order-menu-item']}>
                ...
                <div>
                  余额{' '}
                  <span>
                    (剩余 <span className="price-fmt">{formatPrice(userData.balance)}</span>)
                  </span>
                </div>
              </div>
              <div className={Styles['order-menu-item']}>
          ...
          <div className={Styles['order-tips']}>
            ...
            <div>
              <li>
                <div>*</div>
                <div>即日起购票成功后，订座信息不再发送短信，改为公众号通知或App站内通知</div>
              </li>
              <li>
                <div>*</div>
      ...
      <Popup visible={showCard} closeOnMaskClick={true} onMaskClick={() => setShowCard(false)}>
        <Checkbox.Group
          value={coupon}
          onChange={(val) => {
